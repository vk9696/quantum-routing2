...
data_ka = pd.read_csv('data/wax/beta_0.275/ka_nsd_5_8_10_12.csv')
data_kx0 = pd.read_csv('data/wax/beta_0.275/kx0_nsd_5_8_10_12.csv')
data_kx1 = pd.read_csv('data/wax/beta_0.275/kx1_nsd_5_8_10_12.csv')
data_k10 = pd.read_csv('data/wax/beta_0.275/k10_nsd_5_8_10_12.csv')
...
print(blocking_probabilities_sp)
print(ci_sp)
...
plot_with_confidence(ax, xi_values, blocking_probabilities_ka, ci_ka, 'Knowledge-aware')
plot_with_confidence(ax, xi_values, blocking_probabilities_kx0, ci_kx0, '$kx_{0}$ path-selection', linestyle='--')
plot_with_confidence(ax, xi_values, blocking_probabilities_kx1, ci_kx1, '$kx_{1}$ path-selection', linestyle='--')
plot_with_confidence(ax, xi_values, blocking_probabilities_k10, ci_k10, 'k shortest-path', linestyle='--')

ax.set_yscale('log')
ax.set_xlabel(r'$ \xi $')
ax.set_ylabel('$Blocking \ Probability$')
ax.set_title('Random Topology')
ax.legend()
ax.grid(True)
ax.set_xlim(0.5, 1)
ax.set_ylim(bottom=0.01, top=1)
#plt.show()
plt.savefig('doc/bp_wax_conf.pdf')
